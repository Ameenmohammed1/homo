...
export const metadata: Metadata = {
  title: "Homo | AI Employees by Zuvany",
  description:
    "Homo is a Zuvany sub-project that builds AI employees for businesses — from customer support and appointment booking to trip planning and automation.",
  icons: {
    icon: "/homo.png", // place favicon.ico or any icon in /public folder
  },
};
